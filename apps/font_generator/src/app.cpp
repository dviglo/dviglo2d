...
void App::show_ui()
{
    ...
    // Окно вывода текстур
    {
        ...
        if (generated_font_ && generated_font_->num_textures() > 0)
        {
            ...
            {
                StrUtf8 str = "Число страниц: " + to_string(generated_font_->num_textures());
            ...
            // Изображение
            {
                ...
                BeginChild("ImageScrollArea", ImVec2(0, child_height), true, ImGuiWindowFlags_HorizontalScrollbar);
                Texture* texture = generated_font_->texture(current_page);
